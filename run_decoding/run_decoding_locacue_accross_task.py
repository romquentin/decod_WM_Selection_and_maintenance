"""Run decoding analyses in sensors space for the control task
...
output_folder = '/cross_task_cue_control/'
# Define analyses
...
def make_control_epoch(subject):
...
epochs, events = make_cue_epoch(subject)
epochs_con, events_con = make_control_epoch(subject)
...
for analysis in analyses:
    ...
    kwargs = dict()
    est = GeneralizingEstimator(clf, scoring='roc_auc',
                                n_jobs=24, **kwargs)
    # Run decoding
